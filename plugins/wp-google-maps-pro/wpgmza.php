...
//        }
            ...
            if ($display > 0 && $c_display > 0) {
                ...
                if ($admin) {
                    ...
                    if ($type == 1) {
                        ...
                        if (isset($hide_title_column) && $hide_title_column == "yes") { } else { $wpgmza_tmp_body .= "   <td class='wpgmza_table_title'>".stripslashes($result->title)."</td>"; }
                        if (isset($hide_category_column) && $hide_category_column == "yes") { } else { $wpgmza_tmp_body .= "   <td class='wpgmza_table_category'>".wpgmza_return_category_name($result->category). " </td>"; }
        ...
        if ($admin) {
            ...
            if ($type == 1) {
                $wpgmza_tmp_head .= "
                            <div id=\"wpgmza_marker_list_".$map_id."\" class=\"wpgmza_marker_list_class\" style='width:".$width.";'>
                ...
                if (isset($hide_title_column) && $hide_title_column == "yes") { } else { $wpgmza_tmp_head .= "   <th class='wpgmza_table_title'><strong>".__("Title","wp-google-maps")."</strong></th>"; }
                if (isset($hide_category_column) && $hide_category_column == "yes") { } else { $wpgmza_tmp_head .= "   <th class='wpgmza_table_category'><strong>".__("Category","wp-google-maps")."</strong></th>"; }
                if (isset($hide_address_column) && $hide_address_column == "yes") { } else { $wpgmza_tmp_head .= "   <th class='wpgmza_table_address'><strong>".__("Address","wp-google-maps")."</strong></th>"; }
                if (isset($hide_description_column) && $hide_description_column == "yes") { } else { $wpgmza_tmp_head .= "   <th class='wpgmza_table_description'><strong>".__("Description","wp-google-maps")."</strong></th>"; }
