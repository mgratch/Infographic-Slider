                ...
                if(hashChange) {
                    ...
                    self.ev.on('rsAfterSlideChange', function() {
                        ...
                        hashChangeTimeout = setTimeout(function() {
                            ...
                            var imgHashElems = slide.content.find('.rsImgHash');
                            if(imgHashElems.length) {
                                var imgHashElem = imgHashElems[0];
                                hash = imgHashElem.textContent;
                            } else {
                                hash = (self.currSlideId + 1);
                            }

                            window.location.replace( (''+window.location).split('#')[0] + prefix + hash);
